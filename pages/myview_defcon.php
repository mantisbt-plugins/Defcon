...
$query = "SELECT $bug_table.* FROM $defcon_table,$bug_table WHERE $defcon_table.issue_id = $bug_table.id and  consultant_id = $user  and status < $t_status ORDER BY $bug_table.id DESC";
